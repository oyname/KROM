...
Key TranslateKey(int key)
{
    ...
    case GLFW_KEY_KP_ADD: return Key::Plus;
    case GLFW_KEY_EQUAL: return Key::Equals;
    case GLFW_KEY_KP_EQUAL: return Key::Equals;
    case GLFW_KEY_MINUS: return Key::Minus;
    case GLFW_KEY_KP_SUBTRACT: return Key::Minus;
    ...
    if (key >= GLFW_KEY_A && key <= GLFW_KEY_Z)
        return static_cast<Key>(static_cast<uint16_t>(Key::A) + static_cast<uint16_t>(key - GLFW_KEY_A));
    if (key >= GLFW_KEY_0 && key <= GLFW_KEY_9)
        return static_cast<Key>(static_cast<uint16_t>(Key::Num0) + static_cast<uint16_t>(key - GLFW_KEY_0));
