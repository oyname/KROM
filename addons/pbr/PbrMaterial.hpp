...
public:
    ...
    [[nodiscard]] static PbrShaderAssetSet DefaultShaderAssetSet() noexcept;
    ...
    [[nodiscard]] static MaterialHandle Register(MaterialSystem& materials,
                                                  const PbrMaterialCreateInfo& info);
    [[nodiscard]] static PbrMaterial    Create(MaterialSystem& materials,
                                               const PbrMaterialCreateInfo& info) noexcept;
