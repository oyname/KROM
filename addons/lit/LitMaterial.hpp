...
public:
    ...
    [[nodiscard]] static LitShaderAssetSet DefaultShaderAssetSet() noexcept;
    ...
    [[nodiscard]] static MaterialHandle Register(MaterialSystem& materials,
                                                  const LitMaterialCreateInfo& info);
    [[nodiscard]] static LitMaterial    Create(MaterialSystem& materials,
                                               const LitMaterialCreateInfo& info) noexcept;
